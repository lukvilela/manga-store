...
export default function RelatedVolumes({
  mangaId,
  mangaTitle,
  totalVolumes,
  currentVolume,
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isAdjacent && (
                    <span className="absolute top-2 right-2 px-2 py-0.5 bg-akira-pink text-bg text-[9px] font-mono font-bold uppercase tracking-widest shadow-hard">
